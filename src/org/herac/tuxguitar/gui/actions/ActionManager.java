...
// added by luffah 01/01/2016
import org.herac.tuxguitar.gui.actions.caret.SelectAction;
//
...
// added by luffah 01/01/2016
import org.herac.tuxguitar.gui.actions.effects.ChangeGhostChordAction;
import org.herac.tuxguitar.gui.actions.effects.ChangeGhostStringAction;
...
// added by luffah 01/01/2016
import org.herac.tuxguitar.gui.actions.effects.ChangePalmMuteStringAction;
//
...
// added by luffah 01/01/2016
import org.herac.tuxguitar.gui.actions.note.ChangeCopyChordAction;
import org.herac.tuxguitar.gui.actions.note.ChangeTiedChordAction;
...
public class ActionManager {
	...
	public void init(){
		...
		addAction(new ChangeTiedNoteAction());// added by luffah 01/01/2016
		addAction(new ChangeTiedChordAction());// added by luffah 01/01/2016
		addAction(new ChangeCopyChordAction());// added by luffah 01/01/2016
		...
		addAction(new ChangeGhostNoteAction());// added by luffah 01/01/2016
		addAction(new ChangeGhostChordAction());// added by luffah 01/01/2016
		addAction(new ChangeGhostStringAction());// added by luffah 01/01/2016
		...
		addAction(new ChangePalmMuteStringAction());// added by luffah 01/01/2016
		...
		addAction(new SelectAction());// added by luffah 01/01/2016
